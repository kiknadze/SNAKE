...
level.addEventListener('change', function(){
    switch(document.querySelector('#level').value) {
        case '15':
            document.querySelector('#speednumb').placeholder = 'Type speed between 15-20';
            break;
        case '10':
        document.querySelector('#speednumb').placeholder = 'Type speed between 10-15';
            break;
        case '5':
        document.querySelector('#speednumb').placeholder = 'Type speed between 5-10';
            break;
    }  
})
...
reset.addEventListener('click', function(){
    ...
    document.querySelector('#startImg').style.display = 'inline'; //show image
    document.querySelector('#snake').style.display = 'none'; //hide canvas

    document.querySelector('#level').value = options.level;
    ...
    document.querySelector('#speednumb').value = '';
})
...
setValue.addEventListener('click', function(){
    ...
    if(document.querySelector('#speednumb').value == ''){
        options.level = document.querySelector('#level').value;
    } else if(document.querySelector('#level').value == 15 && document.querySelector('#speednumb').value > 20) {
        options.level = '20';
    } else if(document.querySelector('#level').value == 15 && document.querySelector('#speednumb').value < 15) {
        options.level = 15;
    } else if(document.querySelector('#level').value == 10 && document.querySelector('#speednumb').value > 15) {
        options.level = 15;
    } else if(document.querySelector('#level').value == 10 && document.querySelector('#speednumb').value < 10) {
        options.level = 10;
    } else if(document.querySelector('#level').value == 5 && document.querySelector('#speednumb').value > 10) {
        options.level = 10;
    } else if(document.querySelector('#level').value == 5 && document.querySelector('#speednumb').value < 1) {
        options.level = 1;
    } else {
        options.level = document.querySelector('#speednumb').value;
    }
